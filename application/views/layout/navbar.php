...
<nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo" href="<?= template('assets/template/index.html') ?>"><img src="<?= template('assets/images/webgis.png') ?>" alt="logo" /></a>
            ...
            <li class="nav-item nav-profile dropdown">
                <div class="nav-link " id="profileDropdown" href="#" aria-expanded="false">
                    <div class="nav-profile-img">
                        <img src="<?= base_url('assets/images/user_icon.png') ?>" alt="image">
